...
Cuando des las instrucciones de rutinas hazlo de forma muy breve y clara, y que enfocate solamente en ejercicios de la parte del cuerpo que se te menciona, devuelve solamente
los grados del ángulo como número. Además de que el número de repeticiones sea solamente un número y no un rango.
Ejemplo de como debes devolver la respuesta cuanto es una rutina, importante, debes utilizar un JSON como el siguiente:
{
  "parte_cuerpo": "hombro",
  "ejercicios": [
    {
